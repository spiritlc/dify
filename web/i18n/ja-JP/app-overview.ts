const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'またはHomeGPTagentのクラウドバージョンを無料見積もりでお試しください',
  },
  overview: {
    title: '概要',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: '訪問者がアプリケーションが収集するデータを理解し、HomeGPTagentの<privacyPolicyLink>プライバシーポリシー</privacyPolicyLink>を参照できるようにします。',
        },
      },
      embedded: {
        entry: '埋め込み',
        ...
        chromePlugin: 'HomeGPTagent Chatbot Chrome拡張機能をインストール',
        copied: 'コピーしました',
        copy: 'コピー',
      },
      qrcode: {

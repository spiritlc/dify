const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'HomeGPTagentアカウント',
    langGeniusAccountTip: 'HomeGPTagentアカウントと関連するユーザーデータ。',
    editName: '名前を編集',
  ...
  members: {
    ...
    invitationSentTip: '招待が送信され、彼らはHomeGPTagentにサインインしてあなたのチームデータにアクセスできます。',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'HomeGPTagentが提供するOpenAIホスティングサービスを使用すると、GPT-3.5などのモデルを使用できます。トライアルクォータが使い果たされる前に、他のモデルプロバイダを設定する必要があります。',
      callTimes: '通話回数',
  ...
  apiBasedExtension: {
    title: 'API拡張機能は、HomeGPTagentのアプリケーション全体での簡単な使用のための設定を簡素化し、集中的なAPI管理を提供します。',
  ...
  about: {
    changeLog: '変更ログ',
    updateNow: '今すぐ更新',
    nowAvailable: 'HomeGPTagent {{version}} が利用可能です。',
    latestAvailable: 'HomeGPTagent {{version}} が最新バージョンです。',
  },
  appMenus: {
    overview: '概要',

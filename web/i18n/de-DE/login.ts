const translation = {
  ...
  welcome: 'Willkommen bei HomeGPTagent, bitte melde dich an, um fortzufahren.',
  ...
  license: {
    tip: 'Bevor du mit HomeGPTagent Community Edition beginnst, lies die',
    link: 'Open-Source-Lizenz',
  },
  join: 'Beitreten',
  joinTipStart: 'Lade dich ein, dem',
  joinTipEnd: 'Team auf HomeGPTagent beizutreten',
  invalid: 'Der Link ist abgelaufen',
  explore: 'HomeGPTagent erkunden',

const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Oder probieren Sie die Cloud-Version von HomeGPTagent mit kostenlosem Angebot aus',
  },
  overview: {
    title: 'Übersicht',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Hilft Besuchern zu verstehen, welche Daten die Anwendung sammelt, siehe HomeGPTagents <privacyPolicyLink>Datenschutzrichtlinie</privacyPolicyLink>.',
        },
      },
      embedded: {
        entry: 'Eingebettet',
        ...
        chromePlugin: 'Installieren Sie die HomeGPTagent Chatbot Chrome-Erweiterung',
        copied: 'Kopiert',
        copy: 'Kopieren',
      },
      qrcode: {
      ...
      customize: {
        ...
        way1: {
          ...
          step1Operation: 'HomeGPTagent-WebClient',

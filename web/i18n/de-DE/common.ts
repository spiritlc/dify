const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'HomeGPTagent-Konto',
    langGeniusAccountTip: 'Ihr HomeGPTagent-Konto und zugehörige Benutzerdaten.',
  ...
  members: {
    ...
    invitationSentTip: 'Einladung gesendet, und sie können sich bei HomeGPTagent anmelden, um auf Ihre Teamdaten zuzugreifen.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Der OpenAI-Hostingdienst von HomeGPTagent ermöglicht es Ihnen, Modelle wie GPT-3.5 zu verwenden. Bevor Ihr Probe-Kontingent aufgebraucht ist, müssen Sie andere Modellanbieter einrichten.',
  ...
  apiBasedExtension: {
    title: 'API-Erweiterungen bieten zentralisiertes API-Management und vereinfachen die Konfiguration für eine einfache Verwendung in HomeGPTagents Anwendungen.',
  ...
  about: {
    ...
    nowAvailable: 'HomeGPTagent {{version}} ist jetzt verfügbar.',
    latestAvailable: 'HomeGPTagent {{version}} ist die neueste verfügbare Version.',
  },
  appMenus: {
    overview: 'Übersicht',

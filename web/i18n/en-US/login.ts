const translation = {
  ...
  welcome: 'Welcome to HomeGPTagent, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting HomeGPTagent Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join',
  joinTipStart: 'Invite you join',
  joinTipEnd: 'team on HomeGPTagent',
  invalid: 'The link has expired',
  explore: 'Explore HomeGPTagent',

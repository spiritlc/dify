const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'HomeGPTagent account',
    langGeniusAccountTip: 'Your HomeGPTagent account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    jobNumberErr: 'Please enter a valid job number',
    emailPlaceholder: 'Please input emails',
    sendInvite: 'Send Invite',
    invitedAsRole: 'Invited as {{role}} user',
    invitationSent: 'Invitation sent',
    invitationSentTip: 'Invitation sent, and they can sign in to HomeGPTagent to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by HomeGPTagent allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across HomeGPTagent\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'HomeGPTagent {{version}} is now available.',
    latestAvailable: 'HomeGPTagent {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Overview',

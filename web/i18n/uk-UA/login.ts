const translation = {
  ...
  welcome: 'Ласкаво просимо до HomeGPTagent, будь ласка, увійдіть, щоб продовжити.',
  ...
  license: {
    tip: 'Перед запуском HomeGPTagent Community Edition ознайомтеся з ліцензією з відкритим кодом на GitHub',
    link: 'Ліцензія з відкритим кодом',
  },
  join: 'Приєднуйтесь',
  joinTipStart: 'Запрошуємо вас приєднатися',
  joinTipEnd: 'команда HomeGPTagent',
  invalid: 'Посилання застаріло',
  explore: 'Досліджуйте HomeGPTagent',

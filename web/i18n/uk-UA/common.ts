const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Обліковий запис HomeGPTagent',
    langGeniusAccountTip: 'Ваш обліковий запис HomeGPTagent та пов’язані з ним дані користувача.',
  ...
  members: {
    ...
    invitationSentTip: 'Запрошення надіслано, і вони можуть увійти в HomeGPTagent, щоб отримати доступ до даних вашої команди.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Служба хостингу OpenAI, надана HomeGPTagent, дозволяє використовувати такі моделі, як GPT-3.5. Перш ніж ваша пробна квота буде використана, вам потрібно налаштувати інші постачальники моделі.',
  ...
  apiBasedExtension: {
    title: 'API-розширення забезпечують централізоване керування API, спрощуючи конфігурацію для зручного використання в різних програмах HomeGPTagent.',
    link: 'Дізнайтеся, як розробити власне розширення API.',
    linkUrl: 'https://docs.HomeGPTagent.ai/features/extension/api_based_extension',
  ...
  about: {
    ...
    nowAvailable: 'HomeGPTagent {{version}} тепер доступна.',
    latestAvailable: 'HomeGPTagent {{version}} – це найновіша доступна версія.',
  },
  appMenus: {
    overview: 'Огляд',

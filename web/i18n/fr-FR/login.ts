const translation = {
  ...
  welcome: 'Bienvenue sur HomeGPTagent, veuillez vous connecter pour continuer.',
  ...
  license: {
    tip: 'Avant de commencer HomeGPTagent Community Edition, lisez le GitHub',
    link: 'Licence Open-source',
  },
  join: 'Rejoindre',
  joinTipStart: 'Je vous invite à rejoindre',
  joinTipEnd: 'équipe sur HomeGPTagent',
  invalid: 'Le lien a expiré',
  explore: 'Explorez HomeGPTagent',
